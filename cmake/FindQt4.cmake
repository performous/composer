...
IF (QT4_QMAKE_FOUND)
  ...
  SET(QT_MODULES QtGui Qt3Support QtSvg QtScript QtTest QtUiTools
                 QtHelp QtWebKit QtXmlPatterns phonon QtNetwork QtMultimedia QtMultimediaKit
  ...
  FOREACH(QT_MODULE ${QT_MODULES})
    ...
    # Special handling for QtMobility's QtMultimediaKit
    IF(${QT_MODULE} STREQUAL "QtMultimediaKit")
      FIND_PATH(QT_${_upper_qt_module}_INCLUDE_DIR qaudio.h
                PATHS
                ${QT_HEADERS_DIR}/../${QT_MODULE}
                ${QT_LIBRARY_DIR}/../${QT_MODULE}.framework/Headers
                ${QT_HEADERS_DIR}/${QT_MODULE}
    ...
    ENDIF(${QT_MODULE} STREQUAL "QtMultimediaKit")
